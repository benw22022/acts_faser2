...
class Faser2TelescopeDetectorElement : public Acts::DetectorElementBase {
 public:
  /// @class ContextType
  ...
  Faser2TelescopeDetectorElement(
  ...
  ///  Destructor
  ~Faser2TelescopeDetectorElement() override = default;
...
inline const Acts::Surface& Faser2TelescopeDetectorElement::surface() const {
  return *m_elementSurface;
}

inline Acts::Surface& Faser2TelescopeDetectorElement::surface() {
  return *m_elementSurface;
}

inline double Faser2TelescopeDetectorElement::thickness() const {
  return m_elementThickness;
}

inline const Acts::Transform3& Faser2TelescopeDetectorElement::transform(
    const Acts::GeometryContext& gctx) const {
...
inline const Acts::Transform3& Faser2TelescopeDetectorElement::nominalTransform(
    const Acts::GeometryContext& /*gctx*/) const {
  return *m_elementTransform;
}

inline void Faser2TelescopeDetectorElement::addAlignedTransform(
...
Faser2TelescopeDetectorElement::alignedTransforms() const {
