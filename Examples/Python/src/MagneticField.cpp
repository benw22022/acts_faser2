...
#include "Acts/MagneticField/RestrictedBField_Indu.hpp"
#include "Acts/MagneticField/RestrictedBField_Indu_1Modules.hpp"
#include "Acts/MagneticField/RestrictedBField_Indu_2Modules.hpp"
#include "Acts/MagneticField/RestrictedBField_Indu_3Modules.hpp"
#include "Acts/MagneticField/RestrictedBField_Indu_4Modules.hpp"
...
void addMagneticField(Context& ctx) {
  ...
  py::class_<RestrictedBField_Indu, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBField_Indu>>(m, "RestrictedBField_Indu")
      .def(py::init<Acts::Vector3>());

  py::class_<RestrictedBField_Indu_1Modules, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBField_Indu_1Modules>>(m, "RestrictedBField_Indu_1Modules")
      .def(py::init<Acts::Vector3>());

  py::class_<RestrictedBField_Indu_2Modules, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBField_Indu_2Modules>>(m, "RestrictedBField_Indu_2Modules")
      .def(py::init<Acts::Vector3>());

  py::class_<RestrictedBField_Indu_3Modules, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBField_Indu_3Modules>>(m, "RestrictedBField_Indu_3Modules")
      .def(py::init<Acts::Vector3>());

  py::class_<RestrictedBField_Indu_4Modules, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBField_Indu_4Modules>>(m, "RestrictedBField_Indu_4Modules")
      .def(py::init<Acts::Vector3>());
